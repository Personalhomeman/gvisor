...
import (
	...
	pb "gvisor.dev/gvisor/test/packetimpact/proto/posix_server_go_grpc_proto"
...
var posixServerIP = flag.String("posix_server_ip", "", "ip address to listen to for UDP commands")
var posixServerPort = flag.Int("posix_server_port", 40000, "port to listen to for UDP commands")
...
func NewDUT(t *testing.T) DUT {
	...
	posixServer := pb.NewPosixClient(conn)
	return DUT{
		t:           t,
